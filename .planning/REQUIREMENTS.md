...
- [x] **DSGN-04**: Achieve fast page load (<3s)
...
- [x] **DSGN-08**: Implement dark/light mode toggle
...
- [x] **NAV-02**: Configure homepage to redirect to Now/Thoughts page
