...
* There is a difference bwn output and outcome is software development. Output is what is delivered and an agile team usually track the velocity to speed-up the rate of output. Outcome is what happens after this Output, we measure the difference of actions of our users and if we made their life easier
* In PM the Goal is to minimize output and maximize outcome
* Stories are not requirements, they are discussion about solving problems for our customers and business
...
2. Plan to build less
	...
	* Doing incremental release will allow you to create MVP release, validate learning and prioritize things that we have the bigger impact on outcome
...
3. Plan to learn faster
	* Find first the problem and validate it's a real problem
	...
	* Broken release strategy is all about breaking the value delivered, each release should deliver value and a usable product. A broken release strategy is not breaking into several part the product
	* Never forget that it's really difficult to get the same outcome from all user. Stay focus on your target users and the outcome you want to deliver to them specifically
	* Product Discovery: learn if we are building the right thing
...
5. You already know how
	...
	* Explore alternative story, use "what about"
...
6. The real story about stories
	* The best solutions comes from the collaboration between the persons with the problem to solve and the people who can solve the problem
...
10. Bake stories like cake
	...
	* Break solutions into smaller parts allowing you wo evaluate and progress sooner
...
11. Rock Breaking
	...
	* Evaluate with metrics + interview to really learn if your target outcomes were met
12. Rock Breakers
	* Avoid bottleneck in your agile process by making everybody responsible of writing user stories
	* Product discovery team: PO, Senior Eng., UX designer
	* Solution often come from the Eng. supplied with insight about the business problem and users' problems
...
17. Stories are like actually like asteroids
	* Break down stories progressively so you can release value and avoid backlog filler with lots of tiny stories
